...
public class Statistics implements Serializable {
    ...
    public synchronized String getStatistics(String header, int nodes) {
        ...
        return header + "- Avg time: " + (((double) time) / nodes) + " ms. (" + time + " " + stealRequests + " " + nodes + ") " + stealsPerSecondNode
                + " st/sec/n, " + stealsPerSecond + " st/sec, " + +connectionFailed + " / " + alreadyConnected + " failed/race " + failedPerNode
                + " / " + allreadyPerNode + " (failed/races) / node";
    }
