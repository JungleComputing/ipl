...
#include "ibis_util_io_IbisSerializationInputStream.h"

JNIEXPORT jobject JNICALL Java_ibis_util_io_IbisSerializationInputStream_createUninitializedObject
  (JNIEnv *, jobject, jclass, jclass);

#if THIS_CANNOT_BE
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldDouble
  (JNIEnv *, jobject, jobject, jstring, jdouble);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldLong
  (JNIEnv *, jobject, jobject, jstring, jlong);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldFloat
  (JNIEnv *, jobject, jobject, jstring, jfloat);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldInt
  (JNIEnv *, jobject, jobject, jstring, jint);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldShort
  (JNIEnv *, jobject, jobject, jstring, jshort);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldChar
  (JNIEnv *, jobject, jobject, jstring, jchar);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldByte
  (JNIEnv *, jobject, jobject, jstring, jbyte);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldBoolean
  (JNIEnv *, jobject, jobject, jstring, jboolean);
JNIEXPORT void JNICALL Java_ibis_util_io_IbisSerializationInputStream_setFieldObject
