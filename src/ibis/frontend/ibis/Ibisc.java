...
class Ibisc {
	...
	// Run satinc.
	new ibis.frontend.satin.Satinc(satinVerbose, local, satinVerify, keep, print,
				       invocationRecordCache, className, compiler, 
				       supportAborts, inletOpt, spawnCounterOpt, faultTolerance).start();
...
//		}
	...
	new Ibisc(local, verbose, satinVerbose, satinVerify, iogenVerbose, iogenVerify, keep, print, invocationRecordCache, 
	          targets, packageName, exeName, compiler, mantac, link, doManta, supportAborts, inletOpt, spawnCounterOpt,
