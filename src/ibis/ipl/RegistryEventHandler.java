 ...
 * <p>
 * If the {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is
 * specified for this Ibis, all Ibis instances receive all
...
public interface RegistryEventHandler {
     ...
     * Note: an Ibis instance may also receive a <code>joined</code> upcall
     * for itself.
     * If the {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is
     * specified for this Ibis, all Ibis instances receive the
     * <code>joined</code> upcalls in the same order.
     * If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified,
     * some Ibis instances may be missed, and the order of the upcalls may
     * not be the same.
     * @param joinedIbis
     ...
     * If the {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is
     * specified for this Ibis, all Ibis instances receive the
     * <code>left</code> upcalls in the same order.
     * If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified,
     * some Ibis instances may be missed, and the order of the upcalls may
     * not be the same.
     * @param leftIbis
     ...
     * If the {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is
     * specified for this Ibis, all Ibis instances receive the
     * <code>died</code> upcalls in the same order.
     * If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified,
     * some Ibis instances may be missed, and the order of the upcalls may
     * not be the same.
     * @param corpse
