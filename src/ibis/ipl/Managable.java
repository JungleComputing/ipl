...
public interface Managable {
     ...
     * @exception NoSuchPropertyException is thrown if one or more of the
     ...
     * @exception NoSuchPropertyException is thrown if the
     *     specified property key is not recognized.
     */
