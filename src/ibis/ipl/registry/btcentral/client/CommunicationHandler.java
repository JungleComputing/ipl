...
import ibis.ipl.registry.btcentral.RegistryLocator;
import ibis.ipl.registry.btcentral.VirtualServerSocket;
import ibis.ipl.registry.btcentral.VirtualSocketAddress;
...
import ibis.ipl.registry.btcentral.server.CentralRegistryService;
...
//    private final String connURL = "btspp://localhost:"+MYSERVICEUUID_UUID.toString() + ";name=Ibis";
    ...
    IbisIdentifier join(byte[] implementationData,
        ...
        System.out.println("Joining with " + tmp.toString());
