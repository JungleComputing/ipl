...
final class CommunicationHandler implements Runnable {
    ...
    private final CommunicationStatistics statistics;
    ...
    CommunicationHandler(TypedProperties properties, Pool pool)
        ...
        statistics = new CommunicationStatistics(Protocol.NR_OF_OPCODES);
    ...
    public Map<String, String> getStats() {
        return statistics.getMap(Protocol.OPCODE_NAMES);
    }
    ...
    void bootstrap() throws IOException {
        ...
        try {
            ...
            heartbeat.updateHeartbeatDeadline();
            long end = System.currentTimeMillis();
            statistics.add(Protocol.OPCODE_GET_STATE, end - start, connection
    ...
    public long getSeqno(String name) throws IOException {
        ...
        try {
            ...
            heartbeat.updateHeartbeatDeadline();
            long end = System.currentTimeMillis();
            statistics.add(Protocol.OPCODE_SEQUENCE_NR, end - start, connection
                    .read(), connection.written(), false);
    ...
    public void maybeDead(ibis.ipl.IbisIdentifier ibis) throws IOException {
        ...
        try {
            ...
            heartbeat.updateHeartbeatDeadline();
            long end = System.currentTimeMillis();
            statistics.add(Protocol.OPCODE_MAYBE_DEAD, end - start, connection
                    .read(), connection.written(), false);
        } catch (IOException e) {
            connection.close();
            throw e;
    ...
    void sendHeartBeat() {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            statistics.add(Protocol.OPCODE_HEARTBEAT, end - start, connection
                    .read(), connection.written(), false);
    ...
    public void sendStatistics() {
        ...
        try {
            ...
            pool.getStatistics().writeTo(connection.out());
            connection.getAndCheckReply();
    ...
    public void run() {
        ...
        try {
            ...
            long end = System.currentTimeMillis();
            statistics.add(opcode, end - start, connection.read(), connection
                    .written(), true);
        } catch (IOException e) {
