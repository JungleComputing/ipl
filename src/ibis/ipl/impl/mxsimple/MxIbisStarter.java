...
import ibis.ipl.impl.mx.channels.MxSocket;
...
public final class MxIbisStarter extends ibis.ipl.IbisStarter {
    ...
    static final Logger logger
            = Logger.getLogger("ibis.ipl.impl.mxsimple.MxIbisStarter");
    ...
    public Ibis startIbis(RegistryEventHandler registryEventHandler,
        ...
        return new MxIbis(registryEventHandler, capabilities, portTypes,
                userProperties);
    }
}
