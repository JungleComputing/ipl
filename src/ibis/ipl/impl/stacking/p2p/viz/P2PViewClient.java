...
public class P2PViewClient implements Runnable{
	...
	private static final Logger logger = LoggerFactory
			.getLogger(P2PViewClient.class);

	public P2PViewClient(Ibis ibis, P2PIdentifier p2pID) {
		this.baseIbis = ibis;
		this.p2pID = p2pID;
	}
	 ...
	 */
	public synchronized IbisIdentifier getVisualizerID() {
		return visualizerID;
	}
