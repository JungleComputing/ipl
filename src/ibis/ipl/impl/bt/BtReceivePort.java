/* $Id: TcpReceivePort.java 9325 2008-08-25 10:28:33Z ceriel $ */
...
class BtReceivePort extends ReceivePort implements BtProtocol {

    class ConnectionHandler extends ReceivePortConnectionInfo 
            implements Runnable, BtProtocol {
    ...
    BtReceivePort(Ibis ibis, PortType type, String name, MessageUpcall upcall,
