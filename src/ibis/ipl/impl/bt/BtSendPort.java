...
final class BtSendPort extends SendPort implements BtProtocol {
    ...
    private class Conn extends SendPortConnectionInfo {
        ...
        Conn(IbisSocket s, BtSendPort port, ReceivePortIdentifier target)
                throws IOException {
            super(port, target);
            this.s = s;
    ...
    BtSendPort(Ibis ibis, PortType type, String name,
    ...
    protected SendPortConnectionInfo doConnect(ReceivePortIdentifier receiver,
        ...
        IbisSocket s =
                ((BtIbis) ibis).connect(this, receiver, (int) timeoutMillis,
                        fillTimeout);
