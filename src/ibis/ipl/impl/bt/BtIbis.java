/* $Id: TcpIbis.java 10913 2009-05-14 16:45:26Z nick $ */
...
public final class BtIbis extends ibis.ipl.impl.Ibis implements Runnable,
        BtProtocol {

    static final Logger logger = LoggerFactory
            .getLogger("ibis.ipl.impl.bt.BtIbis");
    ...
    public BtIbis(RegistryEventHandler registryEventHandler,
    ...
    throws IbisCreationFailedException
    {
        ...
        //registry = Registry.createRegistry(capabilities, this, userProperties, data, implementationVersion, applicationTag, credentials);
    ...
    IbisSocket connect(BtSendPort sp, ibis.ipl.impl.ReceivePortIdentifier rip,
    ...
    private void handleConnectionRequest(IbisSocket s) throws IOException {
       ...
       // System.out.println("reading ... [" + s.getInputStream().read() + "]");
        ...
        BtReceivePort rp = (BtReceivePort) findReceivePort(name);
    ...
    public void run() {
        ...
        boolean stop = false;
        //((ibis.ipl.registry.bt.Registry)registry()).setIbisIdentifier(ident);
        while (!stop) {
            IbisSocket s = null;
    ...
    protected SendPort doCreateSendPort(PortType tp, String nm,
        ...
        return new BtSendPort(this, tp, nm, cU, props);
    }
    ...
    protected ReceivePort doCreateReceivePort(PortType tp, String nm,
            ...
            throws IOException {
        return new BtReceivePort(this, tp, nm, u, cU, props);
    }
