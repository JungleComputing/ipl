...
final class JavaMx {
	 ...
	 */
	static native boolean connect(int endpointNumber, int link, long targetNicId, int targetEndpoint, int filter);
	 ...
	 */
	static native boolean connect(int endpointNumber, int link, long targetNicId, int targetEndpoint, int filter, long timeout);
	...
	/**
	 * Cancels a pending request. Note: may not be working on send() request, needs investigation
