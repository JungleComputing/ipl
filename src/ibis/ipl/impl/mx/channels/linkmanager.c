...
/* LinkManager.init() */
JNIEXPORT jboolean JNICALL Java_ibis_ipl_impl_mx_channels_JavaMx_00024LinkManager_init
...
JNIEXPORT jboolean JNICALL Java_ibis_ipl_impl_mx_channels_JavaMx_00024LinkManager_addBlock
