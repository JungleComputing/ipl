...
class IOProps {
    ...
    static final String s_stats_nonrewritten = PROPERTY_PREFIX + "stats.nonrewritten";
    static final String s_stats_written = PROPERTY_PREFIX + "stats.written";
    static final String s_classloader = PROPERTY_PREFIX + "serialization.classloader";
