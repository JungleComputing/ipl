...
public class BinomialCombiner implements java.io.Serializable { 
     ...
     */
    public void combine(int rank1, Exception ex1,
			int rank2, Exception ex2,
			int size) { 
	throw new RuntimeException("void BinomialCombiner.combine(int, Exception, int, Exception, int) not implemented");
    } 
    ...
    public boolean combine(int rank1, boolean result1, Exception e1,
			   ...
			   int size) { 
	throw new RuntimeException("boolean BinomialCombiner.combine(int, boolean, Exception, int, boolean, Exception, int) not implemented");
    } 
    ...
    public byte combine(int rank1, byte result1, Exception e1,
			...
			int size) { 
	throw new RuntimeException("byte BinomialCombiner.combine(int, byte, Exception, int, byte, Exception, int) not implemented");
    } 
    ...
    public char combine(int rank1, char result1, Exception e1,
			int rank2, char result2, Exception e2,
			int size) { 
	throw new RuntimeException("char BinomialCombiner.combine(int, char, Exception, int, char, Exception, int) not implemented");
    } 
    ...
    public short combine(int rank1, short result1, Exception e1,
			 int rank2, short result2, Exception e2,
			 int size) { 
	throw new RuntimeException("short BinomialCombiner.combine(int, short, Exception, int, short, Exception, int) not implemented");
    } 
    ...
    public int combine(int rank1, int result1, Exception e1,
		       int rank2, int result2, Exception e2,
		       int size) { 
	throw new RuntimeException("int BinomialCombiner.combine(int, int, Exception, int, int, Exception, int) not implemented");
    } 
    ...
    public long combine(int rank1, long result1, Exception e1,
			int rank2, long result2, Exception e2,
			int size) { 
	throw new RuntimeException("long BinomialCombiner.combine(int, long, Exception, int, long, Exception, int) not implemented");
    } 
    ...
    public float combine(int rank1, float result1, Exception e1,
			 int rank2, float result2, Exception e2,
			 int size) { 
	throw new RuntimeException("float BinomialCombiner.combine(int, float, Exception, int, float, Exception, int) not implemented");
    } 
    ...
    public double combine(int rank1, double result1, Exception e1,
			  int rank2, double result2, Exception e2,
			  int size) { 
	throw new RuntimeException("double BinomialCombiner.combine(int, double, Exception, int, double, Exception, int) not implemented");
    } 
	...
	throw new RuntimeException("Object BinomialCombiner.combine(int, Object, Exception, int, Object, Exception, int) not implemented");
    } 
} 
