...
Section \ref{Running an Ibis Program} will discuss how to actually
run this program.
...
portprops.add("communication", "OneToOne, Reliable, " + 
			       "AutoUpcalls, ExplicitReceipt");
...
(this will be discussed in Section \ref{Running an Ibis Program}).
...
\mysection{Running an Ibis Program}
