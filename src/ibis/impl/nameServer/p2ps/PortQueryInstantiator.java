...
public class PortQueryInstantiator implements AdvertisementInstantiator {
    /**
     * @return the type of advertisement instantiated
     */
    public String getType() {
        return PortQuery.TYPE;
    }
    ...
    public Advertisement createAdvertisement(Object envelope, Peer peer) 
        ...
        return new PortQuery((Element) envelope);
    }
    ...
    throws IOException {
        return new PortQuery(advertid, peerid);
    }
