...
public final class ForwardingRegistry extends ibis.impl.Registry {
    
    private final ibis.impl.Registry target;

    public ForwardingRegistry(ibis.impl.Registry target) {
        this.target = target;
    }
    ...
    @Override
    public ibis.impl.IbisIdentifier getIbisIdentifier() {
