...
public final class NioInput extends NetInput {
    ...
    NioInput(NetPortType pt, NetDriver driver, String context,
        ...
        byteBuffer = ByteBuffer.allocateDirect(BUFFER_SIZE).order(
        ...
        oneByteBuffer = ByteBuffer.allocateDirect(1).order(
                ByteOrder.nativeOrder());
        oneByteBuffer.clear();
    }
     ...
     */
    private InetAddress getLocalAddress(int number) throws IOException {
        ...
        throw new IOException("Interface " + number + "not found. Only "
    ...
    public void setupConnection(NetConnection cnx) throws IOException {
        ...
        ServerSocket tcpServerSocket = serverSocketChannel.socket();
    ...
    private void receiveByteBuffer() throws IOException {
        ...
        while (byteBuffer.hasRemaining()) {
            ...
            if (DEBUG) {
                System.out.println("        rbb received " + bytesRead
                        + " bytes");
            }
        }
    }
     ...
     * data is not there.
     */
    public void readArray(boolean[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(byte[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(char[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(short[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(long[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(float[] array, int offset, int size)
            throws IOException {
        int length;
     ...
     * data is not there.
     */
    public void readArray(double[] array, int offset, int size)
            throws IOException {
        int length;
