...
//		socketChannel.socket().setTcpNoDelay(true);
     ...
     */
    public void writeArray(byte [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(char [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(short [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(int [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(long [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(float [] array, int offset,
	    int size) throws IOException {
	int length;
    ...
    public void writeArray(double [] array, int offset,
	    int size) throws IOException {
	int length;
