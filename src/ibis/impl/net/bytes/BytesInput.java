...
public final class BytesInput extends NetInput implements Settings,
    ...
    public void readArray(boolean[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2boolean(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(char[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2char(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(short[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2short(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(int[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2int(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(long[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2long(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(float[] ub, int o, int l) throws IOException {
        ...
        if (mtu <= 0) {
            ...
            while (l > 0) {
                ...
                conversion.byte2float(buffer.data, bufferOffset, ub, o,
                        copyLength);
                o += copyLength;
                l -= copyLength;
    ...
    public void readArray(Object[] ub, int o, int l) throws IOException,
