...
public abstract class NetStat {
    ...
    public NetStat(boolean on, String moduleName) {
        ...
        if (on) {
            Runtime.getRuntime().addShutdownHook(
                    new Thread("NetStat ShutdownHook") {
                        public void run() {
                            synchronized (dummy) {
                                report();
                            }
    ...
    protected void reportVal(Number value, String begin, String type,
        ...
        System.err.println(value + " " + begin + " " + plural(type, value)
                + " " + end);
    }
    ...
    protected void reportMap(TreeMap m, String setType, String type) {
        ...
        System.err.println(" - " + plural(setType, m.size()) + " of "
                + plural(type, 2) + " -");
        ...
        while (i.hasNext()) {
            ...
            System.err.println(nb + " " + plural(setType, nb) + " of " + key
                    + " " + plural(type, key));
        }
    }
