...
public class NetSendBuffer extends NetBuffer {
    ...
    public NetSendBuffer(byte[] data, int length) {
        super(data, length);
    }

    public NetSendBuffer(byte[] data, int base, int length) {
        super(data, base, length);
    }

    public NetSendBuffer(byte[] data, int length, NetAllocator allocator) {
