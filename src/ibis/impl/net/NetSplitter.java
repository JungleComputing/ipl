...
public class NetSplitter extends NetOutput implements NetBufferedOutputSupport {
     ...
     */
    public NetSplitter(NetPortType pt, NetDriver driver, String context)
            throws IOException {
     ...
     */
    public synchronized void setupConnection(NetConnection cnx, Object key,
            NetOutput no) throws IOException {
        log.in();
