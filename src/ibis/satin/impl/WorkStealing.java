...
public abstract class WorkStealing extends Stats {
     ...
     * If blockOnServer is true, it blocks on server side until work is
     * available, or we must exit.
     * This is used in MasterWorker algorithms.
     */
    protected void stealJob(Victim v, boolean blockOnServer) {

        if (ASSERTS && stolenJob != null) { throw new IbisError(
    ...
    protected boolean waitForStealReply() {
        ...
        if (stolenJob == null) { return false; }
