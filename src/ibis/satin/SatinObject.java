 ...
 * When the program is not rewritten by the Satin frontend, the methods
 * described here are basically no-ops, and the program will run
 * sequentially. When the program is rewritten by the Satin frontend,
 * calls to spawnable methods, and calls to {@link #sync()} and
 * {@link #abort()} will be rewritten.
 */
public class SatinObject {
	...
	/** Recursively aborts all methods that were spawned by the current 
	...
	**/
	...
	/** Returns whether it might be useful to spawn more methods.
	    If there is enough work in the system to keep all processors busy,
	...
	**/
	...
	/** Returns whether the current method was generated by the machine it is running on.
	    ...
	    @return <code>true</code> if the current invocation is not stolen
