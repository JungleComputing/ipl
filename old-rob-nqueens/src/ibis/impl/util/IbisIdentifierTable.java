...
final public class IbisIdentifierTable {
    ...
    public synchronized int getHandle(Object stream, IbisIdentifier ident) {
        ...
        if (n == null) {
            ...
            sendTable.put(n, n);
            // System.out.println("added " + ident + " with handle "
            //         + n.handle + " to sendtable");
            return -n.handle;
        }

        // System.out.println("found " + ident + " with handle "
        //         + n.handle + " in sendtable");
        return n.handle;
    }

    public synchronized void addIbis(Object stream, int handle,
            IbisIdentifier ident) {
        ...
        // System.out.println("added ibis " + ident + " with handle "
        //         + n.handle + " to rectable");
    }
    ...
    public synchronized IbisIdentifier getIbis(Object stream, int handle) {
        ...
        // System.out.println("found cached ibis " + res.ident
        //         + " handle was " + handle + " in rectable");
        cachehits++;
        return res.ident;
    }
