...
/**
 * This class is an abstraction of the JVM-specific methods used to create an
 * uninitialized object, or to set final fields when deserializing.
 */
abstract class JavaDependentStuff {
    ...
    static final Logger logger = LoggerFactory.getLogger(JavaDependentStuff.class);
    ...
    static {
        ...
        if (clName != null) {
            ...
            try {
                ...
                logger.warn("Warning: could not find or load custom " + "classloader " + clName, e);
            }
        }
    }
     ...
     * documentation, it is not clear that they should. Therefore, if the typeName
     * indicates an array type, and the obvious attempts to load the class fail,
     * this method also tries to load the base type of the array.
     *
        ...
        try {
            ...
            try {
                if (DEBUG && logger.isDebugEnabled()) {
                    logger.debug("Could not load class " + typeName + " using Class.forName(), trying " + "Thread.currentThread()."
                            + "getContextClassLoader().loadClass()");
                    logger.debug("Default class loader is " + JavaDependentStuff.class.getClassLoader());
                ...
                if (typeName.length() > 0 && typeName.charAt(0) == '[') {
                    ...
                    /*
                     * Now try to load the base class, create an array from it and then return its
                     * class.
                     */
     ...
     */
    abstract void setFieldDouble(Object ref, String fieldname, double d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldLong(Object ref, String fieldname, long d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldFloat(Object ref, String fieldname, float d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldInt(Object ref, String fieldname, int d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldShort(Object ref, String fieldname, short d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldChar(Object ref, String fieldname, char d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldByte(Object ref, String fieldname, byte d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldBoolean(Object ref, String fieldname, boolean d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldString(Object ref, String fieldname, String d) throws IOException;

    /**
     * See {@link #setFieldDouble(Object, String, double)} for a description.
     */
    abstract void setFieldClass(Object ref, String fieldname, Class<?> d) throws IOException;
     ...
     */
    abstract void setFieldObject(Object ref, String fieldname, Object d, String fieldsig) throws IOException;
