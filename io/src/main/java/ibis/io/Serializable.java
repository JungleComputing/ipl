...
public interface Serializable {
     ...
     * 
     * @param out
     *            the <code>IbisSerializationOutputStream</code> to which the
     *            object is written
     ...
     * The "level" of an object is determined as follows:
     * <ul>
     ...
     *            fields are written
     * @param lvl
     *            the "level" of the fields written
     * @exception IOException
     *                is thrown when an IO error occurs.
     */
     ...
     *
     * @param in
     *            the <code>IbisSerializationInputStream</code> from which the
     *            fields are read
     * @param lvl
     *            the "level" of the fields read
     * @exception IOException
     *                is thrown when an IO error occurs.
     * @exception ClassNotFoundException
     *                when the class of the object could not be loaded
     */
