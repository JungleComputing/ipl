 ...
 * and libraries. Unfortunately, there are several incompatible versions.
 * This one should work for the newer Android versions.
 ...
 */
class DalvikJavaStuffV2 extends JavaDependantStuff {
    ...
    static {
        try {
            ...
            setFieldBoolean = getMethod(ObjectInputStream.class,
                    "setFieldBool", Object.class, Class.class, String.class, Boolean.TYPE);
            setFieldByte = getMethod(ObjectInputStream.class,
                    "setFieldByte", Object.class, Class.class, String.class, Byte.TYPE);
            setFieldShort = getMethod(ObjectInputStream.class,
                    "setFieldShort", Object.class, Class.class, String.class, Short.TYPE);
            setFieldInt = getMethod(ObjectInputStream.class,
                    "setFieldInt", Object.class, Class.class, String.class, Integer.TYPE);
            setFieldLong = getMethod(ObjectInputStream.class,
                    "setFieldLong", Object.class, Class.class, String.class, Long.TYPE);
            setFieldChar = getMethod(ObjectInputStream.class,
                    "setFieldChar", Object.class, Class.class, String.class, Character.TYPE);
            setFieldFloat = getMethod(ObjectInputStream.class,
                    "setFieldFloat", Object.class, Class.class, String.class, Float.TYPE);
            setFieldDouble = getMethod(ObjectInputStream.class,
                    "setFieldDouble", Object.class, Class.class, String.class, Double.TYPE);
            setFieldObject = getMethod(ObjectInputStream.class,
                    "setFieldObject", Object.class, Class.class, String.class, String.class,
                    Object.class);
            available = true;
        } catch(Throwable e) {
    ...
    DalvikJavaStuffV2(Class<?> clazz) {
        super(clazz);
        if (! available) {
            throw new Error("DalvikJavaStuffV2 not available");
        }
