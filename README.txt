...
Installation instructions, including prerequisite software are contained
in the file "INSTALL.txt".

The programmer's manual in the docs directory ("docs/progman.pdf") contains
a detailed description of the Ibis Application Programmer's interface (API),
...
See INSTALL.txt for instructions on how to build these.

Ibis has its own web-site: http://www.cs.vu.nl/ibis/.
There, you can find more Ibis documentation, papers,
and example application sources. For the latter,
