...
import ibis.satin.impl.faultTolerance.DeleteClusterThread;
import ibis.satin.impl.faultTolerance.DeleteThread;
import ibis.satin.impl.faultTolerance.FaultTolerance;
import ibis.satin.impl.faultTolerance.KillerThread;
import ibis.satin.impl.loadBalancing.ClusterAwareRandomWorkStealing;
import ibis.satin.impl.loadBalancing.LBCommunication;
...
public final class Satin implements Config {
    ...
    public final LBCommunication lbComm;
    ...
    public Satin() {
        ...
        lbComm = new LBCommunication(this, requestedProperties);
    ...
    public void handleDelayedMessages() {
        ...
        // and handle messages generated by the poll
        // (or delayed messages received in upcalls)
        aborts.handleDelayedMessages();
        lbComm.handleDelayedMessages();
    ...
    public void broadcastSOInvocation(SOInvocationRecord r) {
        so.soComm.broadcastSOInvocation(r);
    }
