...
public final class FTCommunication implements Config, ReceivePortConnectUpcall,
    ...
    public FTCommunication(Satin s) {
        this.s = s;
    }
    ...
    public void electClusterCoordinator() throws ClassNotFoundException,
        IOException {
     ...
     */
    public boolean askForJobResult(InvocationRecord r) {
        ...
        if (value.type == GlobalResultTableValue.TYPE_POINTER) {
            ...
            synchronized (s) {
                ...
                s.lbComm.addToOutstandingJobList(r);
            }
    ...
    public void handleLostConnection(IbisIdentifier dead) {
        Victim v = null;
        synchronized (s) {
            ...
            if (dead.equals(s.lbComm.currentVictim)) {
                s.currentVictimCrashed = true;
                s.lbComm.currentVictim = null;
            }
    ...
    public void left(IbisIdentifier leaver) {
        ...
        synchronized (s) {
            ...
            s.so.soComm.removeSOConnection(leaver);
    ...
    protected void handleJoins(IbisIdentifier[] joiners) {
        ...
        s.so.soComm.createSoPorts(joiners);
        ...
        for (int i = 0; i < r.length; i++) {
            ...
            s.so.soComm.addSOConnection(joiner);
    ...
    public void pushResults(Victim victim, Map toPush) {
