...
public final class FaultTolerance implements Config {
    ...
    public GlobalResultTable globalResultTable;
    ...
    public GlobalResultTableValue lookup(InvocationRecord r) {
        return globalResultTable.lookup(r.getStamp());
    }
