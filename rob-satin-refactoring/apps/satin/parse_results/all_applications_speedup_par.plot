...
set yrange [ 1 : 70 ] noreverse nowriteback  # (currently [-10:10] )
...
set locale "C"
plot \
"gnuplot-fib-speedup-par.dat" title "fib" with linespoints, \
"gnuplot-tsp-speedup-par.dat" title "tsp" with linespoints, \
"gnuplot-ida-speedup-par.dat" title "ida" with linespoints, \
"gnuplot-knapsack-speedup-par.dat" title "knapsack" with linespoints, \
"gnuplot-mmult-speedup-par.dat" title "mmult" with linespoints, \
"gnuplot-nqueens-speedup-par.dat" title "nqueens" with linespoints, \
"gnuplot-cover-speedup-par.dat" title "cover" with linespoints, \
"gnuplot-noverk-speedup-par.dat" title "noverk" with linespoints, \
"gnuplot-adapint-speedup-par.dat" title "adapint" with linespoints, \
"gnuplot-fib_threshold-speedup-par.dat" title "fib_threshold" with linespoints, \
"gnuplot-primfac-speedup-par.dat" title "primfac" with linespoints, \
"gnuplot-raytracer-speedup-par.dat" title "raytracer" with linespoints
#    EOF
