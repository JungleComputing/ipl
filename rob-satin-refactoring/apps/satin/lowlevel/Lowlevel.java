...
final class Lowlevel extends ibis.satin.SatinObject implements
    ...
    public void exception_call_Object_no_new(SerializableObject o)
            throws DoneObject {
        throw Lowlevel.doneObject;
    }
    ...
    public static void doVoidExceptionCallTest(Lowlevel l, int n) {
        ...
        System.out.println("exception call void took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doIntExceptionCallTest(Lowlevel l, int n) {
        ...
        System.out.println("exception call int took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doObjectExceptionCallTest(Lowlevel l, int n) {
        ...
        System.out.println("exception call object took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doVoidInletSpawnTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn void took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doIntInletSpawnTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn int took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doObjectInletSpawnTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn object took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doVoidInletSpawnOverriddenTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn void overridden took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
    }
    ...
    public static void doIntInletSpawnOverriddenTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn int overridden took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doObjectInletSpawnOverriddenTest(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn object overridden took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
    }
    ...
    public static void doVoidExceptionCallTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("exception call void no new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doIntExceptionCallTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("exception call int no new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doObjectExceptionCallTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("exception call object no new took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
    }
    ...
    public static void doVoidInletSpawnTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn void no new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doIntInletSpawnTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn int no new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doObjectInletSpawnTestNoNew(Lowlevel l, int n) {
        ...
        System.out.println("inlet spawn object no new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void doNewTest(int n) {
        ...
        System.out.println("throwable new took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
        ...
        System.out.println("overridden throwable new void took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
        ...
        System.out.println("overridden throwable new int took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
        ...
        System.out.println("overridden throwable new Object took "
                + (time / 1000.0) + " seconds, " + ((time * 1000.0) / n)
                + " micro's per call");
    ...
    public static void doSpawnTest(Lowlevel l, int n) {
        ...
        System.out.println("spawn sync void took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
        ...
        System.out.println("spawn sync int took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
        ...
        System.out.println("spawn sync Object took " + (time / 1000.0)
                + " seconds, " + ((time * 1000.0) / n) + " micro's per call");
    }
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.err
                    .println("application lowlevel got wrong number of parameters, need one");
            System.exit(1);
        }
