...
/**
 * This program is to be run as two or more instances. The first instance is a server, others are
 * clients. The Server waits a while, then terminates the pool. The clients use this to detect there is nothing
 * more to be done, and leave.
 */

public class Termination {

    IbisCapabilities ibisCapabilities =
        new IbisCapabilities(IbisCapabilities.ELECTIONS_STRICT, IbisCapabilities.TERMINATION);
