...
class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (cpu == 0) {
                System.out.println("Starting QR of A[" + n + "][" + m + "] on "
                        + ncpus + " cpus.");
            ...
            m1.configure(new CombinedInvocation("QR-REDUCE", cpu, ncpus,
                    new MyCombiner(), new GroupInvocation()),
                    new DiscardReply());
            r.init(ir);
            ...
            if (cpu == 0) {
                ...
                System.out.println("time : max = " + max + " avg = " + avg
                        + " stddev = " + stddev);
            }
            Group.exit();
        } catch (Exception e) {
