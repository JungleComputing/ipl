...
class Main {
    ...
    Main(String[] argv) throws Exception {
        ...
        if (host == 0) {
            System.out
                    .println("Ibis GMI One Dimensional Fast Fourier Transformation");
        ...
        m.configure(new CombinedInvocation("barrier", s.getRank(), cpus,
                new BarrierCombiner(), new SingleInvocation(0)),
                new ReturnReply(0));
