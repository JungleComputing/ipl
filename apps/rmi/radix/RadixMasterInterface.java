...
public interface RadixMasterInterface extends Remote{
    ...
    public TreeInterface[] getTrees(TreeInterface tree, int cpunum) throws RemoteException;
    public PartsInterface[] getParts(PartsInterface part, int cpunum) throws RemoteException;
}
