...
strictfp public class BarnesHutt {
  ...
  void runDistributed() {
    ...
    DasInfo d = new DasInfo();

    //    if (d.hostNumber()==0 )
      System.out.println("Running distributed (" + d.totalHosts() + " nodes)" );

    bhGd.gdNumProcs = d.totalHosts();
    ...
    doProcInfo(d.hostNumber(), d.totalHosts(), d.getHost(0));
