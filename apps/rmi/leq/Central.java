...
class Central extends UnicastRemoteObject implements i_Central {
    ...
    public Central(BroadcastObject bco, int size, int cpus)
    ...
    public synchronized void put(int offset, int size, double[] update,
            double residue) throws RemoteException {
