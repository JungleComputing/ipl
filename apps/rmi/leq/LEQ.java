...
class LEQ {
	...
	System.out.println("Created LEQ on " + cpu + " offset " + offset + " size " + size);
    }
	...
	do {
		...
		System.err.println("Phase = " + phase + " " + residue + " time est. " + (((temp - time)/(1000.0*phase))*6906.0));
	    }
	...
	if (cpu == 0) {
	    System.out.println("Time            : " + (time/1000.0) + " sec." + " (phases: " + phase + ")");
	    System.out.println(cpu + "calc = " + (calc) + " msec." + " comm = " + comm + " msec");
	    /*
