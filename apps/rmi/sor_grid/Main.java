...
class Main {
    ...
    private static void usage(String[] args) {
        ...
        System.out
                .println("Usage: sor [options] [ <NROW> [ <NCOL> [ <ITERATIONS> ] ] ] [ <COMMUNICATION> [ <THREAD> ] ] <args>*");
        System.out.println("");
        ...
        System.out
                .println("COMMUNICATION : ( \"sync\", \"async\"). Communication type. \"async\" = always split phase calculation.");
        System.out
                .println("THREAD        : communication thread type. Only legal value is \"wait\", a single thread is reused");
        System.out.println("args:");
        System.out
                .println("-viz: support visualization, computation does not wait for external viz client.");
        System.out
                .println("-asyncViz: support visualization, computation is done in lockstep with external viz client.");
        System.out
                .println("-var-cpu: determine relative processor speed first, to divide work better");
        System.out.println("\noptions you gave: ");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (hetero_speed) {
                ...
                System.err.println(info.rank() + ": speed "
                        + nodeSpeed[info.rank()]);
