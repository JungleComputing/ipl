...
Asp(i_GlobalData g, int n, boolean use_threads, boolean use_thread_pool, boolean print_result) throws RemoteException {
...
void do_btree_send(BtreePoolSender thread, i_Asp dest, int[] row, int k, int owner) {
...
public void start() {
	...
	System.out.println("\nAsp/manta " +
			   ...
			   (use_thread_pool ? "with threadpool, " : "no threadpool, " ) +
			   "took " + (time/1000.0) + " secs.");
