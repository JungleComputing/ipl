...
public final class StoreArrayInputStream extends ibis.io.ArrayInputStream {
	...
	public final void readArray(boolean[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.boolean_store, boolean_count, a, off, len);
		boolean_count += len;
	}
	
	public final void readArray(byte[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.byte_store, byte_count, a, off, len);
		byte_count += len;
	}
	
	public final void readArray(short[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.short_store, short_count, a, off, len);
		short_count += len;
	}
	
	public final void readArray(char[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.char_store, char_count, a, off, len);
		char_count += len;
	}
	
	public final void readArray(int[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.int_store, int_count, a, off, len);
		int_count += len;
	}
	
	public final void readArray(long[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.long_store, long_count, a, off, len);
		long_count += len;
	}
	
	public final void readArray(float[] a, int off, int len) throws IOException { 
		System.arraycopy(buf.float_store, float_count, a, off, len);
		float_count += len;
	}

	public final void readArray(double[] a, int off, int len) throws IOException { 
