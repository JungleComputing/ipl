    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (info.rank() == 0) {
                ...
                BufferedArrayInputStream in = new BufferedArrayInputStream(s
                        .getInputStream());
                BufferedArrayOutputStream out = new BufferedArrayOutputStream(s
                        .getOutputStream());
                ...
                System.err.println("Write took " + (end - start)
                        + " ms.  => 1 byte latency : "
