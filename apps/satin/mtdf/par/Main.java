...
class Main {
    ...
    public static void do_main(String[] args) {
        ...
        if (args.length == 0) {
            if (!result
                    .equals("  5 |    |  4 |  4 |  4 |  4 |  5 |  5 |  5 |  4 |  4 |  4 |score = 0")) {
    ...
    String search() {
        ...
        System.out.println("application time Awari (" + depth + ","
                + (file == null ? "start" : file) + ") took "
                + ((double) (end - start) / 1000.0) + " seconds");
        System.out.print("application result Awari (" + depth + ","
                + (file == null ? "start" : file) + ") = ");
