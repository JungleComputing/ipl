...
PAR_RUN_COMMAND = (/home/rob/bin/check_rsh_ports; rm -f $(PAR_OUT_FILE) $(PAR_OUT_FILE).*; prun $(EXCLUDES) -o $(PAR_OUT_FILE) $(PAR_TIME) -v -1 $(IBIS_ROOT)/ibis/bin/run_ibis $$s $(NAMESERVER_PORT) $(NAME_SERVER) $(JVM_FLAGS) $(MAIN_CLASS_NAME) $(SMALL_APP_OPTIONS) $(PAR_RUN_OPTIONS) < /dev/null; )
