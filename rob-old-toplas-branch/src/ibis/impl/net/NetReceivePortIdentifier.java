 ...
 */
public final class NetReceivePortIdentifier implements ReceivePortIdentifier,
     ...
     */
    NetReceivePortIdentifier(String name, String type, NetIbisIdentifier ibis,
    ...
    public boolean equals(NetReceivePortIdentifier other) {
        ...
        return (type().equals(other.type()) && ibis.equals(other.ibis)
                && name().equals(other.name()) && o1.equals(o2));
    }
    ...
    public String toString() {
        return ("(" + "NetRecPortIdent: name = "
                + (name == null ? "<null>" : name) + ", " + "type = "
