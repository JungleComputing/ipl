...
public interface RegistryEventHandler {
     ...
     * Ibis, all Ibis instances receive the <code>joined</code> upcalls in the same
     * order. If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified, some
     * Ibis instances may be missed, and the order of the upcalls may not be the
     * same.
     *
     ...
     * {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is specified for this
     * Ibis, all Ibis instances receive the <code>left</code> upcalls in the same
     * order. If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified, some
     * Ibis instances may be missed, and the order of the upcalls may not be the
     * same.
     *
     * @param leftIbis the ibis identifier of the Ibis instance that left the pool.
     */
     ...
     * {@link IbisCapabilities#MEMBERSHIP_TOTALLY_ORDERED} is specified for this
     * Ibis, all Ibis instances receive the <code>died</code> upcalls in the same
     * order. If {@link IbisCapabilities#MEMBERSHIP_UNRELIABLE} is specified, some
     * Ibis instances may be missed, and the order of the upcalls may not be the
     * same.
     *
     ...
     * result of a call by the application. How the receiver of this upcall reacts
     * to this is up to the application.
     *
     * @ibis.experimental
     *
