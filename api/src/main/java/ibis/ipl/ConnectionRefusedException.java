 ...
 * <code>ConnectionRefusedException</code> is thrown to indicate that a sendport
 * connect was refused.
 */
public class ConnectionRefusedException extends ConnectionFailedException {
    ...
    /**
     * Constructs a <code>ConnectionRefusedException</code>. with the specified
     * parameters.
     *
     ...
     */
    public ConnectionRefusedException(String detailMessage, ReceivePortIdentifier receivePortIdentifier, Throwable cause) {
     ...
     */
    public ConnectionRefusedException(String detailMessage, IbisIdentifier ibisIdentifier, String receivePortName, Throwable cause) {
     ...
     *                        attempt.
     */
    public ConnectionRefusedException(String detailMessage, IbisIdentifier ibisIdentifier, String receivePortName) {
