...
public interface SendPortIdentifier extends java.io.Serializable {
    /**
     * Returns the name of the {@link ibis.ipl.SendPort SendPort} corresponding to
     * this identifier.
     *
     ...
     * the same <code>SendPortIdentifier</code> must result in the same hashcode
     ...
     * <code>SendPortIdentifier</code> must compare equal (and result in the same
